...
This demo shows how to reuse Debian prebuilt packages with ISAR while selectively rebuilding component(s) from source using Yocto-style. It is tailored for QEMU targets, so you can evaluate the hybrid flow without access to physical hardware.
